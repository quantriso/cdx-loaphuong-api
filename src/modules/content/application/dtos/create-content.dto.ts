...
export class CreateContentDto {
  ...
  @ApiProperty({
    ...
    example: "Domain-Driven Design is a software development approach that focuses on modeling the business domain...",
    maxLength: 10000,
  })
  @IsString()
  ...
  @ApiProperty({
    ...
    example: "Learn the fundamentals of DDD and how to apply it to your projects",
    maxLength: 500,
    required: false,
  })
  @IsOptional()
